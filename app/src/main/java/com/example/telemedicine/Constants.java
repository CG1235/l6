...
public class Constants {
  ...
  public static final   String TOKEN_KEY            = "com.example.telemedicine.TOKEN_ITSELF";
  public static final   String TOKEN_EXTRA_DATA     = "com.example.telemedicine.TOKEN_EXTRA_DATA";
